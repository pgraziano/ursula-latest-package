...
Known Limitations:
   ...
   Initially, only the havana release is supported.
...
OPENVSWITCH_TO_LINUXBRIDGE = 'openvswitch_to_linuxbridge'
...
class BaseMigrateToMl2_Havana(object):
...
class MigrateLinuxBridgeToMl2_Havana(BaseMigrateToMl2_Havana):

    def __init__(self):
        super(MigrateLinuxBridgeToMl2_Havana, self).__init__(
    ...
    def migrate_segment_dict(self, binding):
        super(MigrateLinuxBridgeToMl2_Havana, self).migrate_segment_dict(
            binding)
...
class MigrateOpenvswitchToMl2_Havana(BaseMigrateToMl2_Havana):

    def __init__(self):
        super(MigrateOpenvswitchToMl2_Havana, self).__init__(
...
class MigrateOpenvswitchToMl2LinuxBridge_Havana(MigrateOpenvswitchToMl2_Havana):

    def migrate_port_bindings(self, engine, metadata):
        super(MigrateOpenvswitchToMl2LinuxBridge_Havana, self).migrate_port_bindings(engine, metadata)

        engine.execute("""
          UPDATE ml2_port_bindings
            SET vif_type='bridge', cap_port_filter=1, driver='linuxbridge'
              WHERE vif_type='ovs' and driver='openvswitch'
        """)


migrate_map = {
    HAVANA: {
        OPENVSWITCH: MigrateOpenvswitchToMl2_Havana,
        LINUXBRIDGE: MigrateLinuxBridgeToMl2_Havana,
        OPENVSWITCH_TO_LINUXBRIDGE: MigrateOpenvswitchToMl2LinuxBridge_Havana,
    },
}
